...
namespace Hulk
{
    public class HulkForm : IExposable, ILoadReferenceable
    {
        public HulkFormDef def;
        public int level = 0;
        ...
        public HulkForm(HulkFormDef newDef, int newLevel, Pawn newOwner)
        {
            def = newDef;
            level = newLevel;
            owner = newOwner;
        ...
        public void ExposeData()
        {
            ...
            Scribe_Defs.Look<HulkFormDef>(ref this.def, "formDef");
        ...
        {
            return "HulkForm_" + def.LabelCap + tempId;
        }
    }
}